...
export default (req, res) => {
  ...
  */
  const injectHTML = (data, { html, title, meta, body, scripts, state }) => {
    ...
    data = data.replace('<link rel="preload" href="https://cdn.smassets.net/assets/wds-react/wds-react.3_1_1.min.css">');
    data = data.replace('<link rel="stylesheet" href="https://unpkg.com/react-vis/dist/style.css">');
